...
<!-- This is my first multipage website using HTML and CSS. It's supposed to be a concert hall site with show times, an about me page, and a home page including a navbar and footer. I tried my best, it doesn't look the most official but I hope to improve as I learn more. -->

<!-- Features include:
    1. A functioning navbar taking you to all other pages on the site
